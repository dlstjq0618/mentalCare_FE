        ...
        >
          ...
          <RoundedButton
            ...
            onClick={() => {
              ...
              window.location.href = `${process.env.NEXT_PUBLIC_VERCEL_ENV === 'production' ?
                "https://mentalcare.rocketdoctor.co.kr/auth/login" : "https://dev.mentalcare.rocketdoctor.co.kr/auth/login"}`
            }}
          >
            상담실 둘러보기
          </RoundedButton>
