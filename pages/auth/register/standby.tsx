...
export default function RegisterCompletedPage() {
  return (
    ...
    >
      ...
      >
        <RegisterPageHeading>승인 대기 중</RegisterPageHeading>
        <Article
          css={{
            display: "flex",
            flexDirection: "column",
        ...
        >
          ...
          >
            ...
            <br />
            <a href="mailto:hello@correctionvitale.com">
              hello@correctionvitale.com
            </a>
          </Address>
          <RoundedButton
            color="orange"
            ...
            onClick={() => {
              window.location.href = "https://www.wouldu.care/";
            }}
          >
            로켓닥터 둘러보기
          </RoundedButton>
